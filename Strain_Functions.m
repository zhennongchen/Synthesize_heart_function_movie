...
%Strain function
E.ll = -0.21*info.EF; %J. Shi (2016) for GLS of endo
...
%Strain function
E.cc = (-0.1.*z_star - 0.34)*info.EF; %J. Shi (2016) for CS of endo (table 3)
...
E.theta = ((-19.9.*z_star + 6.9).*pi/180)*info.EF; %Kocabay (2014) & linear fit by CC Moore (2000)
